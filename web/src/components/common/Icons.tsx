// 依存を増やさないため、アイコンライブラリは使わず必要な分だけ inline SVG で自作する。
// 色は currentColor に任せ、ボタン側の color で塗り分けられるようにする。
type IconProps = {
  size?: number;
};
...
export function TrashIcon({ size = 16 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" aria-hidden="true">
      <path
        d="M4 7H20M9 7V4.5C9 4.22386 9.22386 4 9.5 4H14.5C14.7761 4 15 4.22386 15 4.5V7M6 7L6.6 18.6C6.63 19.35 7.25 19.9375 8 19.9375H16C16.75 19.9375 17.37 19.35 17.4 18.6L18 7"
        stroke="currentColor"
        strokeWidth="1.6"
        strokeLinecap="round"
